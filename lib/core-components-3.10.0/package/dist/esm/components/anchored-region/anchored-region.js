...
import { IntersectionService } from '../../utils/intersection-service.js';
                    ...
                    if (dirCorrectedHorizontalDefaultPosition === 'start' ||
                        ...
                        if (this.currentDirection === Direction.ltr) {
                            dirCorrectedHorizontalDefaultPosition =
                                dirCorrectedHorizontalDefaultPosition === 'start' ? 'left' : 'right';
                        }
                        else {
                            dirCorrectedHorizontalDefaultPosition =
                                dirCorrectedHorizontalDefaultPosition === 'start' ? 'right' : 'left';
                        }
                    }
            ...
            switch (desiredHorizontalPosition) {
                case 'start':
                    ...
                    if (this.horizontalViewportLock && this.anchorRect.left > this.viewportRect.right) {
                        this.translateX =
                            this.translateX - (this.anchorRect.left - this.viewportRect.right);
                    }
                    break;
                case 'insetStart':
                    this.translateX =
                    ...
                    if (this.horizontalViewportLock &&
                        ...
                        this.translateX =
                            this.translateX - (this.anchorRect.right - this.viewportRect.right);
                    }
                    break;
                case 'insetEnd':
                    this.translateX = this.baseHorizontalOffset;
                ...
                case 'end':
                    ...
                    if (this.horizontalViewportLock && this.anchorRect.right < this.viewportRect.left) {
                        this.translateX =
                            this.translateX - (this.anchorRect.right - this.viewportRect.left);
                    }
                    break;
                case 'center':
            ...
            switch (desiredVerticalPosition) {
                case 'start':
                    ...
                    if (this.verticalViewportLock && this.anchorRect.top > this.viewportRect.bottom) {
                        this.translateY =
                            this.translateY - (this.anchorRect.top - this.viewportRect.bottom);
                    }
                    break;
                case 'insetStart':
                    this.translateY =
                    ...
                    if (this.verticalViewportLock &&
                        ...
                        this.translateY =
                            this.translateY - (this.anchorRect.bottom - this.viewportRect.bottom);
                    }
                    break;
                case 'insetEnd':
                    this.translateY = this.baseVerticalOffset;
                ...
                case 'end':
                    ...
                    if (this.verticalViewportLock && this.anchorRect.bottom < this.viewportRect.top) {
                        this.translateY =
                            this.translateY - (this.anchorRect.bottom - this.viewportRect.top);
                    }
                    break;
                case 'center':
...
__decorate([
    attr
], AnchoredRegion.prototype, "density", void 0);
