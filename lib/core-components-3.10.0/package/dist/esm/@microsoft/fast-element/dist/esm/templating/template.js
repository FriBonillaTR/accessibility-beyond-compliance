...
import { renameComponentTags } from "../../../../../../../../../config-1.1.11/package/dist/index.js";
...
export class ViewTemplate {
  ...
  constructor(html, factories = {}, policy) {
    ...
    this.result = null;
    // #ADO#68197
    this.html = renameComponentTags(html);
    this.factories = factories;
  }
  /**
  ...
  withPolicy(policy) {
    if (this.result) {
      throw FAST.error(
        1208 /* Message.cannotSetTemplatePolicyAfterCompilation */
      );
    }
    if (this.policy) {
