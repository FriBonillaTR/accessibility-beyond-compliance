    ...
    >
      <header className="slide-header">
        ...
        <p className="section-subtitle">
          Shifting from checklists to conscious, inclusive design decisions
        </p>
      </header>
      ...
      <main>
        <section aria-labelledby="intentional-practices">
          ...
          <ul className="key-points" role="list">
            <li>
              <strong>Start with empathy</strong> – Understand the lived
              experiences of your users through research, not assumptions.
            </li>
            <li>
              <strong>Design for flexibility</strong> – Create systems that can
              adapt to different needs rather than fixed solutions.
            </li>
            <li>
              <strong>Include diverse voices</strong> – Involve people with
              disabilities in your design process from the beginning.
            </li>
            <li>
              <strong>Test with real users</strong> – Automated tools catch some
              issues, but human testing reveals the real experience.
            </li>
          </ul>
        </section>
        ...
        <section aria-labelledby="sustainable-accessibility">
          ...
          <blockquote>
            "Accessibility isn't a feature you add at the end—it's a lens
            through which you view every design decision."
          </blockquote>
        </section>
      </main>
    </section>
